    ...
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
        <div class="sidebar-brand d-none d-md-flex">
            <a href="http://127.0.0.1:8000/admin/dashboard">
                <img class="sidebar-brand-full" src="https://labkimiafarma.co.id/assets/logo/KFDLogo_min.png" height="46"
                    alt="Laravel">
                <img class="sidebar-brand-narrow" src="https://labkimiafarma.co.id/assets/logo/KFDLogo_min.png" height="46"
                    alt="Laravel">
            </a>
        </div>
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="init">
            <div class="simplebar-wrapper" style="margin: 0px;">
                    ...
                    <div class="simplebar-offset" style="right: 0px; bottom: 0px;">
                        <div class="simplebar-content-wrapper" tabindex="0" role="region"
                            ...
                            <div class="simplebar-content" style="padding: 0px;">
                                ...
                                <li class="nav-item"><a class="nav-link" href="http://127.0.0.1:8000/admin/settings"><i
                                            class="nav-icon fas fa-cogs"></i> Settings</a></li>
                ...
                <div class="simplebar-placeholder" style="width: auto; height: 518px;"></div>
            </div>
