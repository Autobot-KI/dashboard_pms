...
<section class="banner-style-two">
    <div class="pattern-layer" style="background-image: url(/detox/assets/images/shape/pattern-2.png)" style="z-index:-1;"></div>
  
            <div class="sec-title text-center mt-4">
                <p>Dashboard Project 11</p>
                <h2>PELAYANAN</h2>
            </div>
            <iframe title="Project 11" width="100%" height="900px"
