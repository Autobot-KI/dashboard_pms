    ...
    <div class="auto-container">
        <div class="content-box">
            ...
            <div class="pattern-layer" style="background-image: url(http://azim.commonsupport.com/Detox/assets/images/shape/pattern-9.png);"></div>
                ...
                <figure class="image image-2"><img src="{{ asset('http://azim.commonsupport.com/Detox/assets/images/banner/banner-2-3.png') }}" alt=""></figure>
                <figure class="image image-3 wow bounceInDown" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="{{ asset('http://azim.commonsupport.com/Detox/assets/images/banner/banner-2-4.png') }}" alt=""></figure>
