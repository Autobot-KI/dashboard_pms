...
Route::group(['namespace' => 'App\Http\Controllers\Frontend', 'as' => 'frontend.'], function () {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        */
        ...
        //route dashboard
        Route::get('dashboard/visit', 'FrontendController@pelayanan')->name('dashboard');
        Route::get('dashboard/basket_size', 'FrontendController@pemeriksaan')->name('dashboard');
        Route::get('dashboard/revenue', 'FrontendController@pemeriksaan')->name('dashboard');
    });
});
