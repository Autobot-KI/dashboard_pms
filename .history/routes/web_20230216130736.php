...
Route::group(['namespace' => 'App\Http\Controllers\Frontend', 'as' => 'frontend.'], function () {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        */
        ...
        //route dashboard
        Route::get('dashboard/visit', 'FrontendController@visit')->name('dashboard');
        Route::get('dashboard/basket_size', 'FrontendController@basket_size')->name('dashboard');
        Route::get('dashboard/revenue', 'FrontendController@revenue')->name('dashboard');
    });
});
